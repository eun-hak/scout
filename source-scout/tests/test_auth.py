...
class SessionManagerTests(unittest.TestCase):
    def setUp(self):
        self.manager = SessionManager("correct horse", "s" * 32, 86_400)

    def test_password_verification(self):
        self.assertTrue(self.manager.verify_password("correct horse"))
        self.assertFalse(self.manager.verify_password("wrong"))
    ...
    def test_lifetime_cannot_be_less_than_12_hours(self):
        with self.assertRaises(ValueError):
            SessionManager("password", "s" * 32, 43_199)
